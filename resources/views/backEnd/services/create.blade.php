            ...
            <div class="row g-4">
                <div class="col-lg-8">
                    ...
                    <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="sidebar_icon" class="form-control" placeholder="e.g., fa-solid fa-bolt">
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="teaser_text" class="form-control" rows="2" placeholder="Brief intro lines..."></textarea>
                            </div>
                            <div class="col-12">
                                <label class="form-label fw-semibold text-slate-700">Detailed Description</label>
                                <textarea name="details_content" id="editor" class="form-control summernote" rows="5" placeholder="Full technical explanation..."></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
                        ...
                        <input type="text" name="features_section_title" class="form-control mb-3" placeholder="Section Heading (Default: What's Included in This Service)">
                    ...
                    <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
                        ...
                        <input type="text" name="pricing_section_title" class="form-control mb-3" placeholder="Section Heading (Default: Transparent Pricing)">
                        <div id="pricing-container">
                            <div class="row g-2 mb-2 alignment-item-node">
                                <div class="col-md-7"><input type="text" name="rates_titles[]" class="form-control" placeholder="Service Scope Bounds"></div>
                                <div class="col-md-4"><input type="text" name="rates_prices[]" class="form-control" placeholder="e.g., $40 - $60 / Quote Only"></div>
                                <div class="col-md-1"><button type="button" class="btn btn-light border text-danger w-100" onclick="this.closest('.alignment-item-node').remove()">×</button></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
                        ...
                        <input type="text" name="faq_section_title" class="form-control mb-3" placeholder="Section Heading (Default: Frequently Asked Questions)">
                ...
                <div class="col-lg-4">
                    <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="phone_number" class="form-control mb-2" placeholder="Phone Number Override">
                            <input type="text" name="whatsapp_number" class="form-control" placeholder="WhatsApp Override">
                        </div>
                    </div>
                    ...
                    <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
                        ...
                        <input type="text" name="gallery_section_title" class="form-control mb-2" placeholder="Gallery Section Heading">
                    </div>

                    <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
                        <h5 class="fw-bold text-slate-800 mb-3 border-bottom pb-2">Bottom CTA Box</h5>
                        <input type="text" name="action_title" class="form-control mb-2" placeholder="CTA Banner Title">
                        <textarea name="action_subtitle" class="form-control" rows="2" placeholder="CTA Subtitle..."></textarea>
                    </div>

                    <div class="card border-0 shadow-sm rounded-4 p-4">
                        <h5 class="fw-bold text-slate-800 mb-3 border-bottom pb-2">SEO Configurations</h5>
                        <input type="text" name="seo_title" class="form-control mb-2" placeholder="Meta Title">
                        <textarea name="seo_description" class="form-control" rows="3" placeholder="Meta Description String"></textarea>
                    </div>
                </div>
            </div>
        </form>
